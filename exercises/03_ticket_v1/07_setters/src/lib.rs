...
impl Ticket {
    ...
    pub fn new(title: String, description: String, status: String) -> Ticket {
        Ticket::assert_valid_title(&title);
        Ticket::assert_valid_description(&description);
        Ticket::assert_valid_status(&status);
    ...
    pub fn set_title(&mut self, new_title: String) {
        Ticket::assert_valid_title(&new_title);
        self.title = new_title;
    }

    pub fn set_description(&mut self, new_description: String) {
        Ticket::assert_valid_description(&new_description);
        self.description = new_description;
    }

    pub fn set_status(&mut self, new_status: String) {
        Ticket::assert_valid_status(&new_status);
